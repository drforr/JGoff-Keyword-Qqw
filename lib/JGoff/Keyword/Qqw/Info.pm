package JGoff::Keyword::Qqw::Info;
...
{
	package JGoff::Keyword::Qqw::Param;
...
JGoff::Keyword::Qqw::Info - Information about parameter lists
...
=head1 SYNOPSIS
  ...
  my $info = JGoff::Keyword::Qqw::info \&foo;
  ...
  my $invocant = JGoff::Keyword::Qqw::info(method () { 42 })->invocant;  # '$self'
  
  my $slurpy = JGoff::Keyword::Qqw::info(fun {})->slurpy;  # '@_'

=head1 DESCRIPTION

L<C<JGoff::Keyword::Qqw::info>|JGoff::Keyword::Qqw/Introspection> returns
