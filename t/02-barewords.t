...
# ASCII order, later on we'll check for escaping.
#
...
#is_deeply [qqw)a)], ['a']; # Make sure ')' still behaves.
#is_deeply [qqw*a*], ['a'];
#is_deeply [qqw+a+], ['a'];
#is_deeply [qqw,a,], ['a'];
#is_deeply [qqw-a-], ['a'];
...
#is_deeply [qqw[a]], ['a']; # Special case
# \\ doesn't work
#is_deeply [qqw]a]], ['a']; # Non-balanced version
#is_deeply [qqw^a^], ['a'];
#is_deeply [qqw _a_], ['a'];
...
# Now check single escaped character
#
# Ignore ' ', we'll have plenty of those later.
#is_deeply [qqw!\!!], ['!'];
#is_deeply [qqw"\""], ['"'];
...
#is_deeply [qqw&\&&], ['a'];
#is_deeply [qqw´\´´], ['a'];
#is_deeply [qqw(\()], ['a']; is_deeply [qqw(\))], ['a']; # Special cases
#is_deeply [qqw)\))], ['a']; # Make sure ')' still behaves.
#is_deeply [qqw*\**], ['a'];
#is_deeply [qqw+\++], ['a'];
#is_deeply [qqw,\,,], ['a'];
#is_deeply [qqw-\--], ['a'];
...
#is_deeply [qqw<\<>], ['<']; is_deeply [qqw<\>>], ['>']; # Special cases
#is_deeply [qqw=\==], ['='];
...
#is_deeply [qqw[\[]], ['[']; is_deeply [qqw[\]]], [']']; # Special case
# \\ doesn't work
...
#is_deeply [qqw`\``], ['`'];
#is_deeply [qqw a\aa], ['a']; # Not testing escaping just yet.
#is_deeply [qqw b\bb], ['b'];
#is_deeply [qqw c\cc], ['c'];
#is_deeply [qqw d\dd], ['d'];
#is_deeply [qqw e\ee], ['e'];
